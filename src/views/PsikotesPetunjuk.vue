...
<template>
  <div class="rounded-lg bg-white p-10 shadow-xl">
    <div class="mb-10 space-y-1 text-center">
      <h1 class="text-4xl font-bold">Petunjuk Mengerjakan Ujian</h1>
      <p class="text-2xl">{{ alatTesData.nama }}</p>
      <p class="">{{ kelompokTesData.nama }}</p>
    </div>
    <div class="psi-editor mx-auto max-w-4xl" v-html="kelompokTesData.petunjuk"></div>
    <div class="mt-10 flex justify-center">
      <psi-button @click="handleKerjakanTes">Kerjakan Ujian</psi-button>
    </div>
  </div>
</template>
